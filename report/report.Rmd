...
- California is getting cleaner and cleaner. 

- Bernalillo is a particularly "polluted" county.

- With California, we have a richer dataset over time.
...
With this we plot the below geomap with the $R_{i}$ values for the states. We observe the evolution of the ratio for each state and see that there is a particular spike in year 2001 in Conneticut. In addition, the ratio is also decreasing as we approach 2016.
...
### 1.4 The influence of political parties

Why is it that some locations and years, industry seems to thrive and produce more contaminants for no obvious reason? Politics may be the answer. As the Republican party tends to favour looser regulations and the Democratic party tighter regulations, one would expect that the amount of pollution rises and falls along with the party in control. To investigate this we created a dataset which contained both $R_{county}$ and the party which held power in the state at that time.
